  ...
  return (
    ...
    >
      ...
      >
        <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between gap-4">
          <div className="flex items-center gap-2 shrink-0">
            ...
            <span
              className="font-arcade text-lg text-game-yellow hidden sm:block"
          ...
          >
            <a
              ...
              className="text-white/80 font-body text-sm hover:text-white transition-colors hidden md:block tracking-wide"
            >
              HOME
            </a>
            <a
      ...
      <main className="flex-1" id="game">
        ...
        {/* Game container */}
        <section className="max-w-5xl mx-auto px-3 pb-4" aria-label="Game area">
          <div
          ...
          >
            ...
            >
              <div className="flex flex-col md:flex-row gap-2">
                ...
                {/* HUD */}
                <div className="md:w-36 lg:w-44 flex flex-col">
                  {/* Mobile HUD */}
                  <div className="md:hidden flex items-center justify-between bg-game-hud/90 rounded-2xl p-3 mx-1 mb-1">
                    <div className="flex gap-1">
                      {[0, 1, 2].map((i) => (
                        <span
                          key={i}
                          className={`text-xl ${i < game.lives ? "opacity-100" : "opacity-25 grayscale"}`}
                        >
                          ❤️
                        </span>
                      ))}
                    ...
                    <div className="text-center">
                      <p className="font-arcade text-xs text-navy/60 uppercase">
                        Score
                      </p>
                      <p
                    ...
                    {(game.gameStatus === "playing" ||
                      ...
                      <button
                        ...
                        className="bg-navy text-game-yellow font-arcade text-xs px-3 py-1.5 rounded-lg btn-arcade"
                      >
                        {game.gameStatus === "playing" ? "⏸" : "▶"}
                      </button>
                    )}
            ...
            >
              ...
              <div className="mt-4 bg-navy/10 rounded-2xl p-4 border border-navy/20">
                ...
                <ul className="space-y-1.5 font-body text-sm text-foreground/80">
                  ...
                  <li className="flex items-center gap-2">
                    <span>👆</span> Tap left/right side on mobile
                  </li>
                  <li className="flex items-center gap-2">
                ...
                {leaderboard.length === 0 ? (
                  ...
                  <div className="divide-y divide-white/10">
                    {leaderboard.map((entry, idx) => (
                      ...
                      >
                        <span
                          className={`font-arcade text-sm w-7 text-center ${
                            idx === 0
                              ? "text-game-yellow"
                              : idx === 1
                                ? "text-gray-300"
                ...
                {DIFFICULTIES.map((d) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="font-arcade text-xl text-navy mt-1">{hs}</p>
                    </div>
                  );
                })}
              </div>
      ...
      {/* High Scores Modal — native dialog avoids role="dialog" lint rule */}
      {showLeaderboard && (
        <div
